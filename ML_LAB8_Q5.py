...
xor_labels = np.array([0,1,1,0]).reshape(-1,1)
...
# Final outputs
print("XOR MLP Training Finished")
print("Final outputs:")
...
plt.xlabel("Epochs")
plt.ylabel("MSE")
plt.title("XOR Gate Training (MLP)")
plt.show()
